/* ============================================================
   ...
   Cada script tem:
     ...
     exige               o que precisa estar ELETRICAMENTE certo para o
                         script rodar. Escolher o script no deck nao
                         basta: se a montagem nao confere, nada se mexe
                         e o GabuTRON diz o que falta
...
import { verificar } from "./regras.js";
...
export const SCRIPTS = [
  /* ---------- funcionam em qualquer placa ---------- */
  {
    ...
    requisitos: [{ tipo: "aceso", componente: "led" }],
    exige: [{ tipo: "aceso", componente: "led" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "servo180" }, { tipo: "pinoEm", componente: "servo180", pino: "sig", papelAlvo: "pwm" }],
    exige: [{ tipo: "pinoEm", componente: "servo180", pino: "sig", papelAlvo: "pwm" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "lcdi2c" }, { tipo: "pinoEm", componente: "lcdi2c", pino: "sda", papelAlvo: "i2c" }],
    exige: [{ tipo: "ligado", componente: "ultrassonico" }, { tipo: "pinoEm", componente: "lcdi2c", pino: "sda", papelAlvo: "i2c" }],
  ...
  /* ---------- GaburINO ---------- */
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "motordc", n: 2 }, { tipo: "ligado", componente: "ir-linha" }],
    exige: [{ tipo: "ligado", componente: "motordc", n: 2 }, { tipo: "ligado", componente: "ir-linha" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "expansao-servo" }, { tipo: "pinoEm", componente: "expansao-servo", pino: "sda", papelAlvo: "i2c" }],
    exige: [{ tipo: "ligado", componente: "expansao-servo" }, { tipo: "pinoEm", componente: "expansao-servo", pino: "sda", papelAlvo: "i2c" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "rele" }, { tipo: "ligado", componente: "umidade-solo" }],
    exige: [{ tipo: "ligado", componente: "umidade-solo" }, { tipo: "ligado", componente: "rele" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "servo-torque360" }],
    exige: [{ tipo: "ligado", componente: "servo-torque360" }],
  ...
  /* ---------- MicroBURA ---------- */
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "servo180" }],
    exige: [{ tipo: "ligado", componente: "servo180" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "piezo-modulo" }, { tipo: "ligado", componente: "buzzer-passivo" }],
    exige: [{ tipo: "ligado", componente: "piezo-modulo" }, { tipo: "ligado", componente: "buzzer-passivo" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "tft" }],
    exige: [{ tipo: "ligado", componente: "tft" }],
...

  {
    ...
    requisitos: [{ tipo: "mesmoNo", a: { componente: "ledrgb", pino: "gnd" }, b: { componente: "microbura", papel: "gnd" } }],
    exige: [{ tipo: "mesmoNo", a: { componente: "ledrgb", pino: "gnd" }, b: { componente: "microbura", papel: "gnd" } }],
  ...
  /* ---------- Bura32 ---------- */
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "rele3v" }, { tipo: "existe", componente: "keypad" }],
    exige: [{ tipo: "ligado", componente: "rele3v" }, { tipo: "existe", componente: "keypad" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "motor-passo" }, { tipo: "ligado", componente: "uln2003" }],
    exige: [{ tipo: "ligado", componente: "motor-passo" }, { tipo: "ligado", componente: "uln2003" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "motor-drone", n: 2 }, { tipo: "ligado", componente: "mpu6050" }],
    exige: [{ tipo: "ligado", componente: "motor-drone", n: 2 }, { tipo: "ligado", componente: "mpu6050" }],
  ...
  /* ---------- sugestoes da casa, com tema espacial ---------- */
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "cartao-sd" }, { tipo: "ligado", componente: "dht" }],
    exige: [{ tipo: "ligado", componente: "cartao-sd" }, { tipo: "ligado", componente: "dht" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "rele" }],
    exige: [{ tipo: "ligado", componente: "rele" }, { tipo: "ligado", componente: "ldr" }],
  ...
  },
  {
    ...
    saidas: { gaburino: { t10: { modo: "alto" } }, bura32: { e10: { modo: "alto" } } },
    requisitos: [{ tipo: "ligado", componente: "amplificador" }, { tipo: "ligado", componente: "dfplayer" }],
    exige: [{ tipo: "ligado", componente: "dfplayer" }, { tipo: "ligado", componente: "amplificador" }],
  ...
  },
  {
    ...
    requisitos: [{ tipo: "ligado", componente: "ultrassonico" }, { tipo: "ligado", componente: "buzzer-passivo" }],
    exige: [{ tipo: "ligado", componente: "ultrassonico" }, { tipo: "ligado", componente: "buzzer-passivo" }],
...
/* O script so anima se a fiacao fizer sentido. Montagem errada nao
   ganha animacao de brinde: o silencio e a pista de que falta ligacao.
   Devolve a lista do que ainda falta, para o GabuTRON poder dizer. */
export function faltaParaRodar(script, comps, circ) {
  if (!script || !script.requisitos) return [];
  return script.requisitos.filter((r) => !verificar(r, comps, circ));
}
...
/* O script so roda com a montagem coerente. E a diferenca entre um
   simulador que sempre diz "sim" e um que ensina: aqui o programa
   confia na fiacao, e fiacao errada nao produz movimento nenhum. */
export function conferir(script, comps, circ, verificarRegra) {
  if (!script || !script.exige) return { ok: true, faltando: [] };
  const faltando = [];
  for (const regra of script.exige)
    if (!verificarRegra(regra, comps, circ)) faltando.push(regra);
  return { ok: !faltando.length, faltando };
}

/* Texto curto do que falta, para o GabuTRON avisar sem entregar tudo. */
export function descreverFalta(regra, nomeDe) {
  const nome = nomeDe(regra.componente) || regra.componente;
  if (regra.tipo === "aceso") return `o ${nome} nao esta acendendo`;
  if (regra.tipo === "ligado") return regra.n > 1 ? `faltam ${nome} energizados` : `o ${nome} nao esta energizado`;
  if (regra.tipo === "pinoEm") return `o pino ${regra.pino} do ${nome} nao esta num pino de ${regra.papelAlvo}`;
  if (regra.tipo === "mesmoNo") return `falta ligar ${nomeDe(regra.a.componente)} e ${nomeDe(regra.b.componente)}`;
  if (regra.tipo === "existe") return `falta o ${nome} na bancada`;
  return "a montagem nao confere";
}
