/* ============================================================
   ...
   GERADO pelo "Exportar tudo" da ferramenta. Nao edite a mao.

   Alem do corpo em SVG, cada peca pode trazer MARCADORES: os pontos
   onde a bancada desenha por cima o que se mexe, acende, soa ou vibra.
   Eixo de motor, luz de ligado, ondas de som e ponto de vibracao sao
   marcadores — e por isso da para reposiciona-los na ferramenta sem
   quebrar a animacao.

   Origem: desenhos-gabutron-2026-09-07, 76 pecas editadas.
   ============================================================ */
...
export const ARTE = {
  ...
  "laser": {
    ...
    marcadores: [{"tipo":"luz","x":109,"y":23}],
  },
  "lcd16": {
  ...
  "isd1820": {
    svg: `<rect width="335" height="217" rx="7" fill="#B23A32" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="246" cy="18" r="7" fill="#0A0C11" opacity=".5" transform="translate(72 0)"></circle><text x="132" y="104" font-family="monospace" font-size="16" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-3 48)">Gravador de voz ISD1820</text><circle cx="230" cy="134" r="6" fill="#4A1E1E" transform="translate(72 0)"></circle><circle cx="60" cy="84" r="26" fill="#8A2C28" stroke="#4A1614" stroke-width="3"></circle><circle cx="60" cy="84" r="15.6" fill="#A33832"></circle><text x="60" y="126" font-family="monospace" font-size="11" font-weight="500" fill="#C9CDD3" text-anchor="middle">REC</text><circle cx="150" cy="84" r="26" fill="#8A2C28" stroke="#4A1614" stroke-width="3"></circle><circle cx="150" cy="84" r="15.6" fill="#A33832"></circle><text x="150" y="126" font-family="monospace" font-size="11" font-weight="500" fill="#C9CDD3" text-anchor="middle">PLAY E</text><circle cx="240" cy="84" r="26" fill="#8A2C28" stroke="#4A1614" stroke-width="3"></circle><circle cx="240" cy="84" r="15.6" fill="#A33832"></circle><text x="240" y="126" font-family="monospace" font-size="11" font-weight="500" fill="#C9CDD3" text-anchor="middle">PLAY L</text>`,
  },
  "ky037": {
  ...
  "ir-linha": {
    svg: `<rect width="259" height="191" rx="7" fill="#0b376a" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="222" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><text x="120" y="92" font-family="monospace" font-size="12" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-24 5)">Sensor seguidor de linha</text><circle cx="206" cy="122" r="6" fill="#4A1E1E"></circle><rect x="61" y="18" width="114" height="42" rx="4" fill="#1e2229" stroke="#05060A" stroke-width="2" transform="translate(-21 1)"></rect><circle cx="85" cy="36" r="14" fill="#0f0f10" stroke="#05060A" stroke-width="2" transform="translate(-19 4)"></circle><circle cx="85" cy="36" r="14" fill="#0f0f10" stroke="#05060A" stroke-width="2" transform="translate(44 4)"></circle>`,
  },
  "tcs3200": {
  ...
  "ams1117": {
    svg: `<rect width="240" height="168" rx="7" fill="#062965" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="222" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><text x="120" y="80" font-family="monospace" font-size="12" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(1 65)">Regulador 5V AMS1117</text><circle cx="160" cy="94" r="6" fill="#4A1E1E" stroke="#05060A" stroke-width="1" data-luz="1"></circle><circle cx="160" cy="94" r="6" fill="#4A1E1E"></circle><rect x="86" y="82" width="31" height="45" rx="4" fill="#151a23" stroke="#05060A" stroke-width="2" transform="translate(-18 -30)"></rect><rect x="86" y="82" width="31" height="45" rx="4" fill="#151a23" stroke="#05060A" stroke-width="2" transform="translate(22 -29)"></rect>`,
  },
  "stepdown": {
    svg: `<rect width="337" height="189" rx="7" fill="#13274e" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="270" cy="18" r="7" fill="#0A0C11" opacity=".5" transform="translate(43 -1)"></circle><text x="144" y="92" font-family="monospace" font-size="16" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(34 67)">Regulador stepdown</text><circle cx="203" cy="118" r="6" fill="#4A1E1E" stroke="#05060A" stroke-width="1" data-luz="1"></circle><circle cx="58" cy="77" r="36" fill="#3A3F47" stroke="#05060A" stroke-width="2" transform="translate(22 18)"></circle><rect x="152" y="83" width="42" height="42" rx="4" fill="#0f151f" stroke="#05060A" stroke-width="2" transform="translate(-15 -50)"></rect><rect x="152" y="83" width="42" height="42" rx="4" fill="#0f151f" stroke="#05060A" stroke-width="2" transform="translate(-14 1)"></rect><circle cx="58" cy="77" r="24" fill="#3A3F47" stroke="#05060A" stroke-width="2" transform="translate(219 33)"></circle>`,
    marcadores: [{"tipo":"luz","x":203,"y":118}],
  },
  "stepup": {
    svg: `<rect width="318" height="192" rx="7" fill="#131d4e" stroke="#05060A" stroke-width="2" transform="translate(1 -2)"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="270" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><text x="144" y="92" font-family="monospace" font-size="16" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-1 85)">Regulador stepup</text><circle cx="58" cy="77" r="36" fill="#3A3F47" stroke="#05060A" stroke-width="2" transform="translate(19 17)"></circle><rect x="152" y="83" width="42" height="42" rx="4" fill="#0f151f" stroke="#05060A" stroke-width="2" transform="translate(1 -34)"></rect><rect x="152" y="83" width="42" height="42" rx="4" fill="#0f151f" stroke="#05060A" stroke-width="2" transform="translate(2 17)"></rect><circle cx="58" cy="77" r="24" fill="#3A3F47" stroke="#05060A" stroke-width="2" transform="translate(195 49)"></circle>`,
  },
  "fonte-tomada": {
    svg: `<path d="M176 145 L144 156 L144 193" fill="none" stroke="#0b45a2" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"></path><path d="M174 141 L97 143 L96 192" fill="none" stroke="#d20f0f" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"></path><path d="M220 64 L232 64 L233 134 L173 136 L172 152 L254 149 L252 39 L219 40 L218 64 Z" fill="#1b1e26" stroke="#05050a" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><rect width="220" height="126" rx="7" fill="#1B1F26" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="270" cy="18" r="7" fill="#0A0C11" opacity=".5" transform="translate(-67 0)"></circle><text x="144" y="92" font-family="monospace" font-size="16" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-35 17)">Fonte de tomada</text>`,
  },
  "bateria-recarregavel": {
    svg: `<path d="M230 98 L256 98 L254 149 L143 150 L144 169" fill="none" stroke="#135acd" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"></path><path d="M231 113 L242 112 L241 136 L97 137 L97 169" fill="none" stroke="#ea1031" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"></path><rect width="231" height="128" rx="7" fill="#7c7e7d" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="270" cy="18" r="7" fill="#0A0C11" opacity=".5" transform="translate(-54 -1)"></circle><text x="144" y="92" font-family="monospace" font-size="14" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-29 16)">Bateria recarregavel 5V</text>`,
  },
  "suporte-litio": {
  ...
  "sw420": {
    svg: `<rect width="264" height="192" rx="7" fill="#1B4E8A" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="246" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><text x="132" y="92" font-family="monospace" font-size="12" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-29 27)">Sensor de vibracao SW-420</text><circle cx="230" cy="122" r="6" fill="#4A1E1E"></circle><path d="M147 75 L147 53 C147 53 36 52 36 52 C36 52 36 74 36 74" fill="none" stroke="#B9BEC6" stroke-width="8.5" stroke-linecap="round" stroke-linejoin="round"></path><rect x="45" y="28" width="91" height="39" rx="4" fill="#003180" stroke="#05060A" stroke-width="2" transform="translate(1 2)"></rect>`,
  },
  "piezo-modulo": {
    svg: `<rect width="264" height="192" rx="7" fill="#1B4E8A" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="246" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><text x="132" y="92" font-family="monospace" font-size="12" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-44 11)">Modulo de toque piezo</text><circle cx="230" cy="122" r="6" fill="#4A1E1E"></circle>`,
  },
  "piezo": {
  ...
  "velocidade": {
    svg: `<rect width="288" height="192" rx="7" fill="#1B4E8A" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="270" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><text x="144" y="92" font-family="monospace" font-size="16" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(-37 31)">Sensor de velocidade</text><circle cx="254" cy="122" r="6" fill="#4A1E1E"></circle><path d="M49 9 L67 8 L68 41 L98 41 L100 8 L121 9 C121 9 120 80 120 80 C120 80 49 80 49 80 L49 9 Z" fill="#191b1f" stroke="#272b2f" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>`,
  },
  "tp4056": {
    svg: `<rect width="336" height="216" rx="7" fill="#134E3A" stroke="#05060A" stroke-width="2"></rect><circle cx="18" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><circle cx="318" cy="18" r="7" fill="#0A0C11" opacity=".5"></circle><text x="168" y="104" font-family="monospace" font-size="16" font-weight="500" fill="#F2F2EE" text-anchor="middle" transform="translate(0 -1)">Carregador TP4056</text>`,
  },
  "lampada12v": {
