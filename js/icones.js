...
const D = {
  ...
  relogio: `<circle cx="12" cy="12" r="9"/><path d="M12 7v5l4 2" stroke="${A}"/>`,
  usb: `<circle cx="12" cy="20" r="2"/><path d="M12 18V4"/><path d="M9 8l3-4 3 4" stroke="${A}"/><path d="M8 12l4 3 4-5" stroke="${F}"/>`,
  ...
  falar: `<path d="M4 9h4l5-4v14l-5-4H4z" stroke="${A}"/><path d="M16.5 9.5a4 4 0 010 5"/><path d="M19 7a8 8 0 010 10"/>`,
